...
export const Button = ({ label, onPress, disabled, loading, variant = 'primary' }: {
  ...
  <Pressable disabled={disabled || loading} onPress={onPress} style={[styles.button, styles[variant], (disabled || loading) && styles.buttonDisabled]}>
...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#0b1320', padding: 16, gap: 12 },
  title: { color: '#f8fafc', fontSize: 24, fontWeight: '700' },
  subtitle: { color: '#cbd5e1', fontSize: 15 },
  card: { backgroundColor: '#162238', borderRadius: 12, padding: 14, gap: 10 },
  field: { borderWidth: 1, borderColor: '#334155', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, color: '#f8fafc', fontSize: 16 },
